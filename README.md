...
* [d3 v5.5.0](https://d3js.org/)
* [jQuery v3.3.1](https://jquery.com/)
* [p5 v0.6.1](https://p5js.org/)
* [p5.dom.js v0.3.4](https://p5js.org/reference/#/libraries/p5.dom)

You may or may not need these libraries. The default includes only d3 min - code for the others is included but commented out. I also may update this starter to include the node version of these libraries (if available), instead of including them in the <head> tag of our index.html page (the old-school style).
